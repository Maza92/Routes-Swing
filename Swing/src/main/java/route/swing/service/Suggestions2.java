 ...
 * @author Luis
 */
public class Suggestions2 extends javax.swing.JFrame {
    ...
    public Suggestions2(JFrame frame) {
        setUndecorated(true);
        initComponents();
...
//        String selectedSuggestion = jList1.getSelectedValue();
            ...
            Logger.getLogger(Suggestions2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Suggestions2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Suggestions2(new MainPanel(new UserVerificationResponseDto())).setVisible(true);
